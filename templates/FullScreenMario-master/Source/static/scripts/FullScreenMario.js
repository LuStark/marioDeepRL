...
(function (FullScreenMario_1) {
    ...
    var FullScreenMario = (function (_super) {
        ...
        function FullScreenMario(settings) {
            ...
            this.action_record = MarioEvent.NONE;
        ...
        */
        ...
        FullScreenMario.prototype.gameReset = function () {
            var FSM = FullScreenMario.prototype.ensureCorrectCaller(this);
            FSM.setMap();
            FSM.ItemsHolder.setItem("lives", FSM.settings.items.values.lives.valueDefault);
            FSM.ModAttacher.fireEvent("onGameStart");
        ...
        */
        ...
        FullScreenMario.prototype.moveLeft = function () {
            var player = FSM.player;
            player.keys.run = -1;
            player.keys.leftDown = true;
        }

        FullScreenMario.prototype.moveRight = function () {
            var player = FSM.player;
            player.keys.run = 1;
            player.keys.rightDown = true;
        }

        FullScreenMario.prototype.stop = function () {
            var player = FSM.player;
            player.keys.run = 0;
            ...
            //player.keys.canjump = true;
        }

        FullScreenMario.prototype.jumpUp = function () {
            var player = FSM.player;
            player.keys.up = true;
            player.keys.jump = true;
            player.keys.jumplev = 0;
        ...
        FullScreenMario.prototype.jumpUpRight = function () {
            var player = FSM.player;
            player.keys.up = true;
            player.keys.jump = true;
            player.keys.run = 1;
        ...
        */
        ...
        FullScreenMario.prototype.gainLife = function (amount, nosound) {
            var FSM = FullScreenMario.prototype.ensureCorrectCaller(this);
            FSM.action_record = MarioEvent.XUMIN;
        ...
        FullScreenMario.prototype.playerShroom = function (thing, other) {
            ...
            thing.FSM.action_record = MarioEvent.POWERUP;
        ...
        */
        ...
        FullScreenMario.prototype.collideUpCoin = function (thing, other) {
            ...
            thing.FSM.action_record = MarioEvent.RICH;
        };
        /**
        ...
        FullScreenMario.prototype.collideFireball = function (thing, other) {
            ...
            thing.FSM.action_record = MarioEvent.KILL;
        ...
        FullScreenMario.prototype.killPlayer = function (thing, big) {
            ...
            if (big === 2) {
                ...
                if (!big && thing.power > 1) {
                    thing.power = 1;
                    FSM.action_record = MarioEvent.POWERDOWN;
            ...
            FSM.MapScreener.nokeys = true;
            FSM.action_record = MarioEvent.DIED;
            FSM.AudioPlayer.clearAll();
